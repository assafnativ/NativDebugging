...
MACHO_CMD_PATTERN = [
        SHAPE("type",   0,  DWORD(MACHO_COMMANDS.keys())),
        SHAPE("size",   0,  DWORD()),
...
MACHO_HEADER_PATTERN = [
        SHAPE("magic",      0,  DWORD(VALID_MAGICS.keys())),
        SHAPE("cputtype",   0,  DWORD(VALID_CPU_TYPES.keys())),
        SHAPE("cpusubtype", 0,  DWORD()),
        SHAPE("filetype",   0,  DWORD(VALID_FILE_TYPES.keys())),
        SHAPE("ncmds",      0,  DWORD()),
